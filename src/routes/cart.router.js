...
// cartRouter.post('/:cid',cartController.findById) 
...
// cartRouter.get('/:id',cartController.findByIdPopulate)

//ruta para listar todos los carritos
// cartRouter.get('/',cartController.findPopulate)

//PUT api/carts/:cid/products/:pid deberá poder actualizar SÓLO la cantidad de ejemplares del producto por cualquier cantidad pasada desde req.body
// cartRouter.put('/:cid/products/:pid',cartContorller.updateOne)

// PUT api/carts/:cid deberá ACTUALIZAR el carrito con un arreglo de productos con el formato especificado arriba.
//cartRouter.put('/:cid',cartController.5)

// DELETE api/carts/:cid deberá eliminar todos los productos del carrito 
// cartRouter.delete('/:cid',cartController.delete)

// DELETE api/carts/:cid/products/:pid deberá eliminar del carrito el producto seleccionado.
// cartRouter.delete('/:cid/products/:pid',cartController.deletecarrrito)
